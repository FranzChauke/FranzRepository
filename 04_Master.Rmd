...
>*Answer 1: since the fire destroyed mpst plants, Fynbos greenness (NDVI) is low. As the plant populations increases again due to reseeding and resprouting, Fynbos greenness (NDVI) slowly increases until it reaches population carrying capacity which causes the saturation. Populations growth curves follow a similar pattern. It can also be that for a short period after fire, there are more nutrients, space and less plants and therefore less inter/intra species competition, Fynbos greenness (NDVI) increases linearly. As population increases,inter/intra species competition for nutrients starts to affect Fynbos greenness (NDVI) which causes the saturation.*
<br>
...
>*Answer 2: There was a decrease in alpha and lambda estimates by 0.043548 and 0.187716 units respectively.The gamma estimate increased by 0.041033 units*
<br>
...
>*Answer 3: The result shows that model 2 provided a significantly better fit to the data compared to model 1. Therefore model 2 fit_negexpS is better.*

Q4: How many degrees of freedom are there in this ANOVA and why (i.e. what are they)?

>*Answer 4: There are 2 degrees of freedom which indicates  that the more complex model (model 2;fit_negexpS), has two additional parameters*
<br>
...
>*Answer 5: Yes. The full modelfit_negexpMLES is better because it has the lower AIC and the AIC difference is way more than 3 which means the difference between the models is significant*
<br>
...
>*Answer 6: AIC requires the log-likelihood to be maximized. Since the NLS models are not fitted by maximum likelihood, their AIC values should not be compared even though they can be calculated.*
<br>
